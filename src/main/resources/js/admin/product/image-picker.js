!function (a) {
    ...
    a.fn.spartanMultiImagePicker = function (i) {
        var imageInputList = document.querySelectorAll('input[type="file"]')
        var e = imageInputList.length, t = imageInputList.length, n = imageInputList.length, d = {
            fieldName: "",
        ...
        function o(i, n) {
            ...
            var d = i.groupClassName, r = i.rowHeight, o = i.fieldName, s = i.placeholderImage, l = i.dropFileLabel,
                p = s.image, A = "64px", c = '<i class="fas fa-sync fa-spin"></i>';
