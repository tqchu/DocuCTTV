...
<link rel="stylesheet" href="${context}/css/customer/orderDetail.css?rd=${rand}">
...
<div class="order__customer-info-wrapper">
    <div class="order__time-line">
        <div class="order__time-line-item">
            <div class="order__time-line-item__name">Thời gian đặt</div>
            <div class="order__time-line-item__value">
        ...
        <c:if test="${not empty order.confirmTime}">
            <div class="order__time-line-item">
                <div class="order__time-line-item__name">Thời gian xác nhận</div>
        ...
        <c:if test="${not empty order.completedTime}">
            <div class="order__time-line-item">
                <div class="order__time-line-item__name">Thời gian hoàn thành</div>
